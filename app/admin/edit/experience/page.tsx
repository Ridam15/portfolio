              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 rounded-lg bg-gray-50 dark:bg-gray-800/50 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-green-500/50 transition-all duration-300"
                  >
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div>
                  ...
                  <input
                    ...
                    type="month"
                    className={cn(
                      'w-full px-4 py-3 rounded-lg bg-gray-50 dark:bg-gray-800/50 border text-gray-900 dark:text-white',
                      'focus:outline-none focus:ring-2 focus:ring-green-500/50 transition-all duration-300',
                  ...
                  {achievementFields.map((field, index) => (
                    <div key={field.id} className="flex gap-2">
                      <input
                        ...
                        className="flex-1 px-4 py-3 rounded-lg bg-gray-50 dark:bg-gray-800/50 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500/50 transition-all duration-300"
                      />
                  ...
                  {techFields.map((field, index) => (
                    <div key={field.id} className="flex gap-2">
                      <input
                        ...
                        className="flex-1 px-4 py-2 rounded-lg bg-gray-50 dark:bg-gray-800/50 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500/50 transition-all duration-300"
                      />
                      {techFields.length > 1 && (
                        <button
                          type="button"
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-lg bg-gray-50 dark:bg-gray-800/50 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500/50 transition-all duration-300"
                  />
                </div>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-gray-600 dark:text-gray-400 text-sm">Loading experiences...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="flex items-start justify-between gap-4 mb-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="admin-btn px-4 py-2 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-lg hover:shadow-lg hover:shadow-green-500/30 transition-all duration-300 flex items-center gap-2 font-semibold"
              >
